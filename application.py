...
class MainWindow(QMainWindow):
    ...
    @Slot()
    def about(self):
        QMessageBox.about(self, "About NotePy", "The <b>NotePy</b> is a simple Python Notepad  "
                          "modern GUI applications, with a menu bar, "
    ...
    def read_settings(self):
        settings = QSettings('QtProject', 'NotePy')
    ...
    def maybe_save(self):
        if self._text_edit.document().isModified():
            ret = QMessageBox.warning(self, "NotePy", "The document has been modified.\nDo you want to save "
    ...
    def load_file(self, fileName):
        ...
        if not file.open(QFile.ReadOnly | QFile.Text):
            ...
            QMessageBox.warning(
                self, "NotePy", f"Cannot read file {fileName}:\n{reason}.")
            return
    ...
    def save_file(self, fileName):
        ...
        if error:
            QMessageBox.warning(self, "NotePy", error)
            return False
    ...
    def set_current_file(self, fileName):
        ...
        self.setWindowTitle(f"{shown_name}[*] - NotePy")
...
if __name__ == '__main__':
    argument_parser = ArgumentParser(
        description='NotePy', formatter_class=RawTextHelpFormatter)
